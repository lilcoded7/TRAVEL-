            ...
            (function(t) {
                ...
                function h(t) {
                    for (var i = 1; i < arguments.length; i++) {
                        ...
                        i % 2 ? c(Object(e), !0).forEach((function(i) {
                            l(t, i, e[i])
                        })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e)) : c(Object(e)).forEach((function(i) {
                ...
                i.a = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/63b77dcd282", "/css/min-widget.css"),
                            isLoaded: !1,
                            clickEvent: "touchend",
                            resizeWidth: 0
                        }
                    },
                    computed: h(h({}, Object(o.c)({
                        ...
                        styleObject: function() {
                            ...
                            if (this.isRight ? o["right:"] = "".concat(a, "px !important;") : o["left:"] = "".concat(a, "px !important;"), this.isCenter) {
                                if (o["top:"] = "calc((50% - ".concat(.5 * e.height, "px) + ").concat(i, "px) !important;"), !this.isRoundWidget) {
                                    ...
                                    this.mobileBrowserName ? (n = "0 0 !important", this.isRight ? (o["left:"] = "calc(100% - ".concat(this.iFrameHeight, " - ").concat(this.xOffsetMobile * this.zoomRatio, "px) !important;"), r = "rotate(-90deg) translateX(-50%) !important") : (o["right:"] = "85% !important;", o["left:"] = "calc(".concat(this.iFrameHeight, " + ").concat(this.xOffsetMobile * this.zoomRatio, "px) !important;"), r = "rotate(90deg) translateX(-50%) !important")) : this.isRight ? o["right:"] = "".concat(s, "px !important;") : o["left:"] = "".concat(s, "px !important;"), o["transform-origin:"] = n, o["-webkit-transform:"] = "".concat(r, ";"), o["-ms-transform:"] = "".concat(r, ";"), o["transform:"] = "".concat(r, ";")
                                }
                            ...
                            }), 250) : o["display:"] = "none !important;", h(h({}, this.genericStyles), o)
                        },
