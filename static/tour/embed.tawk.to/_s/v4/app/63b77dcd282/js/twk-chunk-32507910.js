                ...
                u = Object(h.a)(l, (function() {
                    ...
                    return t.refreshHeader ? a("div", t._l(t.header, (function(e, s) {
                        return a("div", {
                            ...
                            class: ["header-card card--" + e.type, e.content.alignment && "card--alignment-" + e.content.alignment]
                        }, [a("tawk-image", {
                            attrs: {
                            ...
                            class: [e.content.alignment && "card--alignment-" + e.content.alignment],
                            attrs: {
                                role: "heading"
                            }
                        }, [a("tawk-emoji", {
                            ...
                            class: ["tawk-flex card--" + e.type, e.content.alignment && "card--flex-" + e.content.alignment]
                        }, [a("agent-card", {
                            attrs: {
            ...
            var h = {
                ...
                d = Object(u.a)(h, (function() {
                    ...
                    return !t.isConversationCard || t.isConversationCard && t.showConversationCard ? a("div", {
                        ...
                        class: [t.card.content.alignment && "card--alignment-" + t.card.content.alignment],
                        attrs: {
                            role: "heading"
                        }
                    }, [a("tawk-emoji", {
        ...
        5688: function(t, e, a) {
            ...
            var s = a("e906").a,
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    })], 1), t._v(" " + t._s(t.$i18n("menu", "sound_off")) + " ")])]), t.isWindowed ? t._e() : a("tawk-button", {
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            isText: !0,
                            size: "small"
                    ...
                    })], 1), t._v(" " + t._s(t.$i18n("menu", "end_chat_session")) + " ")]) : t._e(), t.branding && !t.branding.whitelabeled ? a("tawk-button", {
                        staticClass: "tawk-text-left tawk-flex tawk-flex-middle",
                        attrs: {
                            href: t.branding.url,
                            target: "blank",
                    ...
                    })], 1), t._v(" " + t._s(t.$i18n("menu", "add_chat_to_your_website")) + " ")]) : t._e()], 1)], 1) : t._e(), t.isWindowed || t.isRoundWidget && !t.mobileBrowserName ? t._e() : a("tawk-button", {
                        directives: [{
                            name: "tawk-tooltip",
                            rawName: "v-tawk-tooltip"
                        }],
        ...
        "6bf7": function(t, e, a) {
            ...
            (function(t) {
                ...
                e.a = {
                    ...
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/63b77dcd282", "/css/max-widget.css"),
                            classString: "",
                            showEndChat: !1,
                            noZoomMetaTag: null,
                            resizeHeightTo: null,
                    ...
                    computed: m(m({}, Object(s.c)({
                        ...
                        styleObject: function() {
                            ...
                            return this.isWindowed || this.isEmbedded ? e["position:"] = "absolute !important;" : e["position:"] = "fixed !important;", this.isWindowed || this.mobileBrowserName || this.isEmbedded ? (e["bottom:"] = "0px !important;", e["right:"] = "0px !important;", e["left:"] = "0px !important;", e["top:"] = "0px !important;") : (t = this.isCenter && this.isRoundWidget ? this.minDesktop.width + this.xOffset + 10 : this.xOffset - 10, this.isRight ? e["right:"] = "".concat(t, "px !important;") : e["left:"] = "".concat(t, "px !important;"), this.isRoundWidget ? this.isBottom ? e["bottom:"] = "".concat(this.minDesktop.height + this.yOffset + 10, "px !important;") : (e["top:"] = "".concat(this.minDesktop.height + this.yOffset + 10, "px !important;"), e["bottom:"] = "auto !important;") : e["bottom:"] = "0px !important;"), "max" === this.chatWindowState || this.isWindowed || this.isEmbedded ? e["display:"] = "block !important;" : e["display:"] = "none !important;", m(m({}, this.genericStyles), e)
                        },
                    ...
                    methods: m(m({}, Object(s.b)({
                        ...
                        loaded: function() {
                            ...
                            if (this.hasHomeView || (this.updateRoute({
                                ...
                                d.type = "text/css", u.appendChild(d), h.appendChild(u), d.styleSheet ? d.styleSheet.cssText = m.nodeValue : d.appendChild(m)
                            }
        ...
        "7ea7": function(t, e, a) {
            ...
            var s = a("f3c3").a,
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    }), t._v(" " + t._s(t.$i18n("home", "chat_button")) + " ")], 1)], 1) : t._e(), t.showReturnToLiveChatBtton ? a("div", {
                        staticClass: "tawk-max-footer-actions"
                    }, [a("tawk-button", {
                        staticClass: "tawk-max-footer-actions-button",
                        attrs: {
                    ...
                    }), t._v(" " + t._s(t.$i18n("chat", "return_to_live_chat")) + " ")], 1)], 1) : t._e(), a("tawk-branding", {
        ...
        d6a3: function(t, e, a) {
            ...
            var s = a("6bf7").a,
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    }), t.isWebrtcEnabled ? a("call-widget") : t._e(), a("tawk-overlay", {
                        ref: "view-overlay",
                        style: {
                            borderRadius: t.borderRadius
                        },
            ...
            var s = a("702b").a,
                ...
                r = Object(i.a)(s, (function() {
                    ...
                    return a("base-frame", {
                        ...
                        ref: "tawk-home-body"
                    }, [t.needConsent ? a("consent-form") : a("home-body", {
                        attrs: {
                            state: t.pageStatus
                        },
                        on: {
