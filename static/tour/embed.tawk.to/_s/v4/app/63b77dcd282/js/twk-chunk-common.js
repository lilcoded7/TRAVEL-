                    ...
                    return function(t, e, n) {
                        ...
                        value: function(t, e) {
                            ...
                            i.a.get("".concat("https://va.tawk.to", "/v1/widget-settings"), {
                                ...
                                }, n.languageScript.async = !0, n.languageScript.charset = "UTF-8", n.languageScript.src = "".concat("https://embed.tawk.to/_s/v4/app/63b77dcd282", "/languages/").concat(o.data.widget.language, ".js")
                            }))
                        }
                    }, {
                        key: "processSettings",
                ...
                var l = function(e) {
                    ...
                    return function(t, e, n) {
                        ...
                        value: function(e, n, i, o) {
                            if ("file:" === window.location.protocol) return t.Tawk_Window.webStorage.localStore.setItem(e, n);
                            if (this.isEnabled) {
                                var r, a, s = "",
                                    c = "Lax;";
                                if (i || ((r = new Date).setTime(r.getTime() + 15552e6), s = "; expires=".concat(r.toGMTString())), window.top !== window) {
                                    var u = !1;
                                    try {
                                ...
                                return o = o ? "; domain=".concat(o) : "", "https:" === window.location.protocol && (a = " Secure"), document.cookie = "".concat(e, "=").concat(n).concat(s, "; path=/").concat(o, "; SameSite=").concat(c).concat(a, ";"), !0
                            }
                        }
                    }, {
                        key: "getItem",
                        ...
                        key: "checkItemSaved",
                        value: function(e) {
                            if ("file:" === window.location.protocol) return !!t.Tawk_Window.webStorage.localStore.getItem(e);
                ...
                var I = function() {
                    ...
                    return function(t, e, n) {
                        ...
                        value: function() {
                            ...
                            t.Tawk_Window.jsApi.local_API.embedded && (k.a.commit("widget/setIsEmbedded", !0), k.a.commit("browserData/setMobileBrowserName", null)), t.Tawk_Window.jsApi.triggerApiHandlers("onBeforeLoad"), t.Tawk_Window.maximize = !1;
