    ...
    t((function() {
        ...
        function u() {
            ...
            document.dispatchEvent(new CustomEvent("ht_ctc_event_settings", {
                ...
                e.preventDefault(), document.querySelector("#ctc_opt") ? t("#ctc_opt").is(":checked") || _("g_optin") ? f(c) : t(".ctc_opt_in").show(400).fadeOut("1").fadeIn("1") : f(c), document.dispatchEvent(new CustomEvent("ht_ctc_event_greetings"))
                ...
                c = c.replace(/\[url]/gi, e), c = encodeURIComponent(c), s.url_structure_d && "yes" !== n ? window.open("https://web.whatsapp.com/send?phone=" + t + "&text=" + c, "_blank", "noopener") : window.open("https://wa.me/" + t + "?text=" + c, "_blank", "noopener"), m(this), v(t)
            })), t(document).on("click", ".ctc_chat, #ctc_chat", (function(e) {
                f(this), t(this).hasClass("ctc_woo_place") && e.preventDefault()
        ...
        function d(e = "open") {
            t(".ctc_cta_stick").remove(), t(".ht_ctc_chat_greetings_box").show(70), t(".ht_ctc_chat_greetings_box").addClass("ctc_greetings_opened").removeClass("ctc_greetings_closed"), i("g_action", e), "user_opened" == e && i("g_user_action", e)
        }
        ...
        function p(e) {
            try {
                ...
                if (t(".ht_ctc_chat_greetings_box").length) {
                    ...
                    })), s.g_init && "open" == s.g_init && "user_closed" !== _("g_user_action") && d("init"), t(document).on("click", '.ctc_greetings, #ctc_greetings, .ctc_greetings_now, [href="#ctc_greetings"]', (function(t) {
                        l("element"), d("element")
                    }))
                }
            }(),
        ...
        function m(t) {
            ...
            } else "undefined" != typeof __gaTracker && __gaTracker("send", "event", o, a, _);
        ...
        function f(c) {
            ...
            var a = s.number,
                _ = s.pre_filled;
            if (c.hasAttribute("data-number") && (a = c.getAttribute("data-number")), c.hasAttribute("data-pre_filled") && (_ = c.getAttribute("data-pre_filled")), _ = _.replace(/\[url]/gi, e), _ = encodeURIComponent(decodeURI(_)), "" != a) {
                var i = "https://wa.me/" + a + "?text=" + _,
                    r = s.url_target_d ? s.url_target_d : "_blank";
                "yes" == n ? (s.url_structure_m && (i = "whatsapp://send?phone=" + a + "&text=" + _, r = "_self"), s.custom_link_m && "" !== s.custom_link_m && (i = s.custom_link_m)) : (s.url_structure_d && (i = "https://web.whatsapp.com/send?phone=" + a + "&text=" + _), s.custom_link_d && "" !== s.custom_link_d && (i = s.custom_link_d));
        ...
        function v(e) {
            if (s.hook_url) {
                var c = s.hook_url,
                    n = {};
                if (s.hook_v) n = s.hook_v;
                document.dispatchEvent(new CustomEvent("ht_ctc_event_hook", {
                    detail: {
                        ctc: s,
                        number: e
                    }
                })), c = s.hook_url, n = s.hook_v, data = JSON.stringify(n), t.ajax({
                    url: c,
                    type: "POST",
                    mode: "no-cors",
                    data: data,
